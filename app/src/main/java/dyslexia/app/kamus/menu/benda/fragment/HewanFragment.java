...
public class HewanFragment extends Fragment {
    ...
    public static HewanFragment newInstance() {
    ...
    private void loadData() {
        ...
        //ArrayList<Dictionary> imageList = (ArrayList<Dictionary>) databaseDictionary.retrieveKamus("Nomina_h");
        ArrayList<WordEntity> imageList = (ArrayList<WordEntity>) appDatabase.wordDao().getByType("Nomina_h");
