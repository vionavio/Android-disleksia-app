package dyslexia.app.permainan.kuis.game;
...
import dyslexia.app.permainan.kuis.WordShuffler;
import dyslexia.app.services.AccountService;

import static dyslexia.app.utils.Constant.GAME_KETERANGAN;
...
public class GameKataKeteranganActivity extends AppCompatActivity {
    ...
    private String[] names = new String[]{"salon",
            "masjid",
            "rumah",
            "gereja",
            "adik",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_kata_keterangan);
    ...
    private void checkAnswer() {
        ...
        if (answer.equals(word)) {
            ...
            score++;
            tvScore.setText("SCORE: " + score);
            Toast.makeText(GameKataKeteranganActivity.this, "Benar", Toast.LENGTH_SHORT).show();
        } else if (!(answer.equals(word))) {
            question++;
            tvQuestionCount.setText("Pertanyaan: " + question + "/" + 10);
            Toast.makeText(GameKataKeteranganActivity.this, "Salah", Toast.LENGTH_SHORT).show();
        }
        setImage();
