...
public class SayurFragment extends Fragment {
    ...
    public static SayurFragment newInstance() {
    ...
    private void loadData() {
        ...
        //ArrayList<Dictionary> imageList = (ArrayList<Dictionary>) databaseDictionary.retrieveKamus("Nomina_s");
        ArrayList<WordEntity> imageList = (ArrayList<WordEntity>) appDatabase.wordDao().getByType("Nomina_s");
