package dyslexia.titi.frag27.kamus.menu.angka;
...
public class AngkaFragment extends Fragment {
    ...
    public static AngkaFragment newInstance() {
        return new AngkaFragment();
    }
    ...
    private void loadData() {
        ...
        ArrayList<Dictionary> imageList = (ArrayList<Dictionary>) databaseDictionary.retrieveKamus("Numeral");
